...
class PositionWithCovGraph:
    ...
    def plot_position_results(self):
        ...
        plt.tight_layout()
        plt.savefig('/home/raquel/catkin_ws/src/turtlebot3_datasets/graphs/amcl/amcl_position_plot.png', dpi=300)
        plt.close()
        
if __name__ == '__main__':
    # Path to the .npz file containing saved data
    npz_filepath = '/home/raquel/catkin_ws/src/turtlebot3_datasets/data/amcl/amcl_bag_data.npz'
