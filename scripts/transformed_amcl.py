...
class PathPublisher:
    def __init__(self):
        ...
        self.pose_covariance_publisher = rospy.Publisher('/robot_pose_with_covariance_amcl', PoseWithCovarianceStamped, queue_size=10)
    ...
    def amcl_pose_callback(self, amcl_msg):
        ...
        try:
            ...
            pose_stamped.header = amcl_msg.header
            pose_stamped.pose = amcl_msg.pose.pose  # Use the pose from Odometry

            # Transform the pose from the 'map' frame to the 'mocap' frame
            transformed_pose = tf2_geometry_msgs.do_transform_pose(pose_stamped, transform)
            transformed_pose.header.stamp = amcl_msg.header.stamp
            ...
            self.publish_pose_with_covariance(amcl_msg, transformed_pose)
    ...
    def publish_pose_with_covariance(self, amcl_msg, transformed_pose):
        ...
        pose_with_covariance_msg.pose.covariance = amcl_msg.pose.covariance
